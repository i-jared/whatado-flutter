...
Chat$Subscription$ChatSubscription$Survey$Answers$Votes
  ...
  return Chat$Subscription$ChatSubscription$Survey$Answers$Votes()
    ..id = json['id'] as int
...
Chat$Subscription$ChatSubscription$Survey$Answers
    _$Chat$Subscription$ChatSubscription$Survey$AnswersFromJson(
        Map<String, dynamic> json) {
  return Chat$Subscription$ChatSubscription$Survey$Answers()
    ..id = json['id'] as int
    ..text = json['text'] as String
    ..votes = (json['votes'] as List<dynamic>)
        .map((e) =>
            Chat$Subscription$ChatSubscription$Survey$Answers$Votes.fromJson(
...
Chat$Subscription$ChatSubscription$Survey
    _$Chat$Subscription$ChatSubscription$SurveyFromJson(
        Map<String, dynamic> json) {
  return Chat$Subscription$ChatSubscription$Survey()
    ..id = json['id'] as int
    ..question = json['question'] as String
    ..answers = (json['answers'] as List<dynamic>)
        .map((e) => Chat$Subscription$ChatSubscription$Survey$Answers.fromJson(
            e as Map<String, dynamic>))
        .toList();
}
